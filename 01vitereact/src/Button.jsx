function getButtonStyleType(buttonStyle) {
...
function Button({ text = 'Button', buttonType = 'ok', buttonStyle }) {



    return (
        <button
            className="p-3 m-1 bg-red-400 text-3xl border-slate-950 rounded-lg hover:bg-red-600 transition-all"
            type={buttonType}
            style={getButtonStyleType(buttonStyle)}
        >
            {text}
        </button>
    )
